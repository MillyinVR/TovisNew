  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className={`fixed inset-0 z-50 ${isMenuOpen ? 'visible' : 'invisible'}`}>
        ...
        {/* Menu Panel */}
        <div
          className={`absolute top-0 left-0 w-[280px] sm:w-96 h-full bg-white transform transition-transform duration-300 overflow-hidden ${
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1501699169021-3759ee435d66?q=80&w=1919&auto=format&fit=crop)',
      ...
      <div className="relative z-10 h-screen overflow-y-auto" style={{ scrollPaddingTop: '72px' }}>
        ...
        <div
          className="scroll-fade-section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16"
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-200 max-w-3xl mx-auto px-4">
              Connect with top beauty professionals in your area. Book appointments for hair,
              makeup, nails, and more.
            </p>
            ...
            <div className="mt-12 sm:mt-16 max-w-3xl mx-auto px-4">
              <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-sm rounded-xl p-6 sm:p-8 text-left">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-3 text-xl sm:text-2xl font-semibold text-white">
                    Stay on Trend!
                  </h3>
                </div>
                <p className="text-gray-200 text-sm sm:text-base mb-6">
                  Find professionals already offering the trending services you're seeing on your
                  favorite social media platforms. No more guessing if they can create your desired
                  look - book with confidence!
                </p>
            ...
            <div className="mt-8 sm:mt-12 max-w-3xl mx-auto px-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 sm:p-8 text-left">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-3 text-xl sm:text-2xl font-semibold text-white">
                    Book with your Party!
                  </h3>
                </div>
                <p className="text-gray-200 text-sm sm:text-base mb-6">
                  Planning a special event? Create a Special Event account and connect with your
                  friends or family to book together. Perfect for weddings, proms, or any group
                  celebration!
                </p>
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <Link
            ...
            <div className="mt-12 sm:mt-16 grid grid-cols-1 gap-4 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 px-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="mt-2 text-sm sm:text-base text-gray-200">
                    Coordinate appointments for your entire party
                  </p>
                </div>
