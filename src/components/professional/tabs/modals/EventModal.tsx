...
export const EventModal: React.FC<EventModalProps> = ({
  ...
  const isPendingAppointment =
    selectedEvent && selectedEvent.type === 'booking' && selectedEvent.status === 'pending';
  ...
  const handleRescheduleClick = () => {
    if (selectedEvent) {
      ...
      const endDate =
        typeof selectedEvent.end === 'string' ? parseISO(selectedEvent.end) : selectedEvent.end;
                ...
                <div className="flex">
                  ...
                  <div className="ml-2 sm:ml-3">
                    <p className="text-xs sm:text-sm text-yellow-700">
                      This time slot is outside your working hours. You can still schedule it, but
                      it may affect client expectations.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-2 sm:ml-3">
                    <p className="text-xs sm:text-sm text-green-700">
                      Appointment rescheduled successfully. A notification has been sent to the
                      client for approval.
                    </p>
                  </div>
                </div>
            ...
            {rescheduleError && (
              <div className="mb-3 sm:mb-4 bg-red-50 border-l-4 border-red-400 p-2 sm:p-4">
                <div className="flex">
                  ...
                  <div className="ml-2 sm:ml-3">
                    <p className="text-xs sm:text-sm text-red-700">{rescheduleError}</p>
                  </div>
                </div>
              </div>
            )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      defaultValue={getTimeString(
                        selectedEvent?.end ||
                          (selectedDate && new Date(selectedDate.getTime() + 60 * 60 * 1000))
                      )}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm"
                      required
                    />
