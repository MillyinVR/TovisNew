            ...
            <div className="mt-2 space-y-3 sm:space-y-4">
              {bookings.length === 0 ? (
                ...
                bookings.map((booking) => (
                  <div
                    key={booking.id}
                    className="rounded-lg border border-gray-200 p-3 sm:p-4 hover:bg-gray-50"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                      <div className="mb-2 sm:mb-0">
                        ...
                        >
                          <h4 className="font-medium text-gray-900 group-hover:text-indigo-600 flex items-center text-sm sm:text-base">
                            {booking.clientName}
                            <User className="ml-1 h-3 w-3 sm:h-4 sm:w-4 opacity-0 group-hover:opacity-100 text-gray-400" />
                          </h4>
                        </button>
                        <p className="text-xs sm:text-sm text-gray-500">{booking.service}</p>
                      ...
                      <div className="flex items-center space-x-2 justify-end">
                        ...
                        <span
                          className={`inline-flex rounded-full px-2 py-0.5 sm:py-1 text-xs font-semibold ${
