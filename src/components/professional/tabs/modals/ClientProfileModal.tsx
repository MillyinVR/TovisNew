...
export const ClientProfileModal: React.FC<ClientProfileModalProps> = ({
  ...
  const totalRating = clientProfileData.reviews.reduce(
    (sum: number, review: ClientReview) => sum + review.rating,
    0
  );
  const averageRating =
    clientProfileData.reviews.length > 0 ? totalRating / clientProfileData.reviews.length : 0;
        ...
        <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-5xl sm:align-middle w-full mx-2 sm:mx-auto">
          <div className="bg-white px-3 sm:px-4 pt-4 sm:pt-5 pb-3 sm:pb-4 sm:p-6 sm:pb-4">
            <div className="flex items-center justify-between pb-3 sm:pb-4 border-b">
              <div>
                <h3 className="text-lg sm:text-2xl font-medium leading-6 text-gray-900">
                  {clientProfileData.displayName}'s Profile
                </h3>
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <div className="border-b border-gray-200">
                ...
                >
                  <a
                    href="#services"
                    className="border-indigo-500 text-indigo-600 whitespace-nowrap py-2 sm:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm"
                  >
                    <div className="flex items-center">
                  ...
                  <a
                    href="#notes"
                    className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-2 sm:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm"
                  >
                    <div className="flex items-center">
                    ...
                    {clientProfileData.serviceHistory.map((service: ServiceRecord) => (
                      ...
                      >
                        ...
                        {service.images && service.images.length > 0 && (
                          <div className="mt-3">
                            <p className="font-medium text-xs sm:text-sm text-gray-600 mb-2">
                              Service Images:
                            </p>
                ...
                {clientProfileData.reviews.length > 0 ? (
                  <div className="space-y-3 sm:space-y-4">
                    {clientProfileData.reviews.map((review: ClientReview) => (
                      <div key={review.id} className="rounded-lg border border-gray-200 p-3 sm:p-4">
