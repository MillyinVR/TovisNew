...
export const PendingProfessionalDashboard = () => {
    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes('storage/unauthorized')) {
          setError(
            'You do not have permission to upload files. Please ensure you are logged in with the correct account.'
          );
  ...
  const handleUpdateVerification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        'Verification information and documents updated successfully. An admin will review your submission.'
      );
    } catch (error) {
              ...
              <div className="sm:flex sm:items-start sm:justify-between">
                <div>
                  ...
                  <div className="mt-2 max-w-xl text-sm text-gray-500">
                    {hasSubmittedDocuments ? (
                      <p>
                        Your professional credentials are currently under review. This process
                        typically takes 2-3 business days.
                      </p>
                    ) : (
                      <p>
                        Please submit your professional credentials and verification documents to
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Upload your best work samples and organize them by category. High-quality
                      images and videos will help attract more clients.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Link your Instagram and TikTok accounts to showcase your work and grow your
              ...
              <dl className="divide-y divide-gray-200">
                <div
                  className={`py-4 space-y-1 ${
                    !hasSubmittedDocuments ? 'cursor-pointer hover:bg-gray-50' : ''
                  }`}
                    ...
                    {verificationData.professionalType === 'makeup_artist' && (
                      <>
                        <div>
                          ...
                          >
                            {Object.entries(MAKEUP_ARTIST_VERIFICATION_TYPES).map(
                              ([value, label]) => (
                                <option key={value} value={value}>
                                  {label}
                                </option>
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setVerificationData((prev) => ({
                                  ...prev,
                                  verificationTypeTwo: e.target
                                    .value as MakeupArtistVerificationType,
                                }))
                              }
                              className={`mt-1 block w-full rounded-md ${
              ...
              <div className="mt-6 border-t border-gray-200 pt-6">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <p className="mt-1 text-xs text-gray-500 truncate">
                              {doc.type === 'license'
                                ...
                                : doc.type === 'government_id'
                                  ? 'Government ID'
                                  : doc.type === 'verification_one'
                                    ? 'First Verification'
                                    : doc.type === 'verification_two'
                                      ? 'Second Verification'
                                      : doc.type}
                            </p>
                          </div>
                    ...
                    <>
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-gray-900">
                          {
                            MAKEUP_ARTIST_VERIFICATION_TYPES[
                              userProfile?.professionalProfile?.verificationTypeOne || 'union_card'
                            ]
                          }
                        </dd>
                      </div>
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-gray-900">
                          {
                            MAKEUP_ARTIST_VERIFICATION_TYPES[
                              userProfile?.professionalProfile?.verificationTypeTwo ||
                                'editorial_credit'
                            ]
                          }
                        </dd>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">
                      {new Date(
                        userProfile?.professionalProfile?.submissionDate || ''
                      ).toLocaleDateString()}
                    </dd>
                  </div>
                </dl>
